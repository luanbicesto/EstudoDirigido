...
public class GAConfiguration {
    public static final int NUMBER_GENERATIONS = 300;
    ...
    public static int PERCENTAGE_HYBRID_POPULATION = 10;
    public static double PERCENTAGE_APPLY_HYBRID_TRANSFORMATION = 0.8;
}
